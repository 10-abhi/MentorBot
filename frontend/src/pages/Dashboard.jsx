...
import { Settings, HelpCircle, LogOut, User, FileText, DollarSign, MoreHorizontal } from 'lucide-react';
          ...
          <div className="lg:w-1/5 mb-6 lg:mb-0">
            ...
            <nav>
              <ul className="space-y-4">
                <li className="flex items-center text-indigo-600 bg-indigo-100 p-2 rounded-lg">
                  <User className="mr-2" size={20} /> Profile
                </li>
                <li className="flex items-center text-gray-600"><DollarSign className="mr-2" size={20} /> Billings</li>
                <li className="flex items-center text-gray-600"><FileText className="mr-2" size={20} /> Invoices</li>
                <li className="flex items-center text-gray-600"><Settings className="mr-2" size={20} /> Settings</li>
                <li className="flex items-center text-gray-600"><HelpCircle className="mr-2" size={20} /> Help</li>
                <li className="flex items-center text-gray-600"><LogOut className="mr-2" size={20} /> Log out</li>
              </ul>
            </nav>
          </div>
          ...
          <div className="lg:w-4/5 lg:pl-8">
            <header className="flex justify-between items-center mb-6">
              ...
              <div className="flex items-center border p-2 rounded-xl">
                <span className="mr-2">{data.toLocaleDateString('en-GB',options)}</span>
                ...
                <div key={index}>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      ...
                      style={{ width: `${(item.value / item.maxValue) * 100}%`, backgroundColor: item.color }}
                    ></div>
                  </div>
                </div>
              ))}
